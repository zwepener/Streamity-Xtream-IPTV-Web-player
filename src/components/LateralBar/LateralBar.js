...
const LateralBar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`netflix-nav netflix-nav-black ${navbar ? "visible" : ""}`}
      >
        <div
          className={`netflix-nav netflix-nav-red ${navbar ? "visible" : ""}`}
        >
          <div
            className={`netflix-nav netflix-nav-white ${navbar ? "visible" : ""}`}
          >
            <button
                  ...
                  <ul>
                        ...
                        onClick={() =>
                          history.replace(
                            location.pathname.replace(
                              "menu",
                              location.pathname.replace("menu", "search"),
                            ),
                          )
                        }
                      >
                    ...
                    <li>
                      <button
                        ...
                        onClick={() =>
                          history.replace(
                            location.pathname.replace("menu", "tvguide"),
                          )
                        }
                      >
                    ...
                    <li>
                      <button
                        className="lateral-focus"
                        onClick={() => history.replace("/live/category/")}
                      >
                ...
                <li>
                  <ul>
                    ...
                    <li>
                      <button
                        className="lateral-focus"
                        onClick={() => history.replace("/movie/category/")}
                      >
                        <i className="fas fa-grip-lines mr-2"></i>
                        Select category
                      </button>
