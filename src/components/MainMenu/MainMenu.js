...
const MainMenu = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setStyle("nav-active");
      document.querySelector(".nav__list-item") &&
        document.querySelector(".nav__list-item").focus();
    }, 10);
  }, []);
        ...
        <div className="nav__content">
          <ul tabIndex={0} className="nav__list" onKeyDown={moveFocus}>
            <li
              ...
              onClick={() => redirect("/live/category/")}
            >
              <button className="hover-target">Live Channels</button>
            </li>
            <li
              tabIndex={-1}
              className="nav__list-item"
            ...
            >
              <button className="hover-target">Movies</button>
            </li>
            <li
              tabIndex={-1}
              className="nav__list-item"
            ...
            >
              <button className="hover-target">TV Series</button>
            </li>
            <li
              tabIndex={-1}
              className="nav__list-item"
            ...
            >
              <button className="hover-target">account info</button>
            </li>
          </ul>
        </div>
      </Box>
