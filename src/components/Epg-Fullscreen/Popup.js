...
const Popup = () => {
  ...
  useEffect(() => {
    if (Info && playlist) {
      setCh(
        playlist.find((x) => parseInt(x.stream_id) === parseInt(Info.chId)),
      );
          ...
          <div>
            <Body>
              <div>
                ...
                <DateDiv>
                  <div>
                    {dateFormat(new Date(Info.start), h24Format)} -{" "}
                    {dateFormat(new Date(Info.stop), h24Format)}
                  </div>
                </DateDiv>
              </div>
              {Info.description && (
                ...
                <Button
                  onClick={() => {
                    ...
                    setTimeout(() => {
                      ...
                      focusElement.getFocus() &&
                        focusElement.getFocus().focus();
                    }, 50);
                  }}
                  autoFocus
                >
