        ...
        <div className="nav__content">
          <ul tabIndex={0} className="nav__list" style={{ padding: "0 20%" }}>
            <Li tabIndex={-1} className="nav__list-item">
              Username:{" "}
              <button className="hover-target">{info.username}</button>
            </Li>
            <Li tabIndex={-1} className="nav__list-item">
              Password:{" "}
              <button className="hover-target">{info.password}</button>
            </Li>
            <Li tabIndex={-1} className="nav__list-item">
              Max connections:{" "}
              <button className="hover-target">{info.max_connections}</button>
            </Li>
            <Li tabIndex={-1} className="nav__list-item">
              Expire on:{" "}
              <button className="hover-target">
                {info.expiry.toGMTString()}
              </button>
            </Li>
            <Li tabIndex={-1} className="nav__list-item">
              {info.message}
            ...
            <div class="row">
              <div class="col-8">
                <Li
                  ...
                  onClick={() => back()}
                >
                  <Button className="form-control">RETURN BACK</Button>
                </Li>
              </div>
              <div class="col-4">
                <Li tabIndex={-1} className="nav__list-item" onClick={logout}>
                  <ButtonLogout className="form-control">LOGOUT</ButtonLogout>
                </Li>
              </div>
            </div>
          </ul>
