...
export default class InfiniteGrid extends React.Component {
  ...
  _getGridHeight() {
    return this.props.entries.length < this.state.itemDimensions.itemsPerRow
      ...
      : Math.floor(
          this.props.entries.length / this.state.itemDimensions.itemsPerRow,
        ) * this.state.itemDimensions.height;
  }
  ...
  _totalRows() {
    const scrolledPastHeight =
      (this.props.entries.length / this._itemsPerRow()) * this._itemHeight();
  ...
  _lazyCallback() {
    if (
      !this.state.initiatedLazyload &&
      this.state.maxItemIndex === this.props.entries.length &&
  ...
  componentDidUpdate(prevProps, prevState) {
    if (typeof this.props.renderRangeCallback === "function") {
      this.props.renderRangeCallback(
        this.state.minItemIndex,
        this.state.maxItemIndex,
      );
    }
  }
